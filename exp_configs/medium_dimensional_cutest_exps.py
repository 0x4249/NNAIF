...
def get_medium_dimensional_CUTEst_benchmark_dict(benchmark_name,
                                                 opt_dict_list,
                                                 num_samples=1,
                                                 max_func_evals=2000, 
                                                 runs=25):
    """
    Get medium dimensional (50 < d <= 200) CUTEst benchmark tests. 
    ...
    if benchmark_name in ["Medium Dimensional No Noise"]:
        cutest_problem_dict_list = [{"CUTEst problem":"ARGTRIGLS",
                                     "SIF params":{"N":200},
                                     "solution":0.0},
                                    {"CUTEst problem":"COATING",
                                     "SIF params":{},
                                     "solution":0.0},
                                    {"CUTEst problem":"GENHUMPS",
                                     "SIF params":{"N":100},
                                     "solution":0.0},
                                    {"CUTEst problem":"GENROSE",
                                     "SIF params":{"N":100},
                                     "solution":1.0},
                                    {"CUTEst problem":"MANCINO",
                                     "SIF params":{"N":100},
                                     "solution":0.0},
                                    {"CUTEst problem":"POWELLSG",
                                     "SIF params":{"N":80},
                                     "solution":0.0},
                                    {"CUTEst problem":"QUARTC",
                                     "SIF params":{"N":100},
                                     "solution":0.0}
                                   ]
        ...
        raise ValueError("The medium dimensional (50 < d <= 200) CUTEst benchmark %s is not implemented..." % benchmark_name)
...
for benchmark_name in benchmarks_list:
    benchmark_dict = get_medium_dimensional_CUTEst_benchmark_dict(benchmark_name,
                                                                  opt_dict_list)
    MED_DIM_CUTEST_EXP_GROUPS["%s" % benchmark_name] = hu.cartesian_exp_group(benchmark_dict)
