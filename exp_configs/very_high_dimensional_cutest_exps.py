...
def get_very_high_dimensional_CUTEst_benchmark_dict(benchmark_name,
                                                    opt_dict_list,
                                                    num_samples=1,
                                                    max_func_evals=2000, 
                                                    runs=25):
    """
    Get very high dimensional (d > 3000) CUTEst benchmark tests. 
    ...
    # Very high dimensional (d > 3000) problems
    # ===============
    if benchmark_name in ["Very High Dimensional No Noise"]:
        cutest_problem_dict_list = [{"CUTEst problem":"BROYDNBDLS",
                                     "SIF params":{"N":5000},
                                     "solution":0.0},
                                    {"CUTEst problem":"DIXMAANC",
                                     "SIF params":{"M":3000},
                                     "solution":1.0}, 
                                    {"CUTEst problem":"NONDIA",
                                     "SIF params":{"N":5000},
                                     "solution":0.0},
                                    {"CUTEst problem":"POWELLSG",
                                     "SIF params":{"N":5000},
                                     "solution":0.0},
                                    {"CUTEst problem":"POWER",
                                     "SIF params":{"N":5000},
                                     "solution":0.0},
    ...
    elif benchmark_name in ["Very High Dimensional Scaled Noise"]:
        cutest_problem_dict_list = [{"CUTEst problem":"BROYDNBDLS",
                                     "SIF params":{"N":5000},
                                     "solution":0.0},
                                    {"CUTEst problem":"DIXMAANC",
        ...
        raise ValueError("The very high dimensional (d > 3000) CUTEst benchmark %s is not implemented..." % benchmark_name)
...
NNAIF_dict_list = [{"name":"NNAIF",
                    ...
                    "surrogate fit optimizer dictionary":{"name":"ADAM",
                                                          ...
                                                          "parameter regularization dictionary":{"type":"Model Specific",
                                                                                                 "alpha_x":1e-4,
                                                                                                 "kwargs":{"regularization type":"L2-All"}},
...
# Benchmark setup 
# ===============
VERY_HIGH_DIM_CUTEST_EXP_GROUPS = {}
...
for benchmark_name in benchmarks_list:
    benchmark_dict = get_very_high_dimensional_CUTEst_benchmark_dict(benchmark_name,
                                                                     opt_dict_list)
    VERY_HIGH_DIM_CUTEST_EXP_GROUPS["%s" % benchmark_name] = hu.cartesian_exp_group(benchmark_dict)
