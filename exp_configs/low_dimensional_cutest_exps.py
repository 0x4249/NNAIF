...
def get_low_dimensional_CUTEst_benchmark_dict(benchmark_name,
                                              opt_dict_list,
                                              num_samples=1,
                                              max_func_evals=2000,
                                              runs=25):
    """
    Get low dimensional (0 < d <= 50) CUTEst benchmark tests. 
    ...
    # Rosenbrock (i.e. banana) function
    # ===============
    if benchmark_name in ["Rosenbrock No Noise"]:
        cutest_problem_dict_list = [{"CUTEst problem":"ROSENBR",
                                     "SIF params":{},
                                     "solution":0.0}
                                   ]
        noise_type_list = ["additive"]
        obj_noise_dict_list = [{"name":"zero sampler",
                                "radius":0.0}
                              ]
    ...
    elif benchmark_name in ["Rosenbrock Scaled Noise"]:
        cutest_problem_dict_list = [{"CUTEst problem":"ROSENBR",
                                     "SIF params":{},
                                     "solution":0.0}
                                   ]
    ...
    # Low dimensional (0 < d <= 50) problems
    # ===============
    elif benchmark_name in ["CUTEst No Noise"]:
        cutest_problem_dict_list = [{"CUTEst problem":"ARGTRIGLS",
                                     "SIF params":{"N":10},
                                     "solution":0.0},
                                    {"CUTEst problem":"BEALE",
                                     "SIF params":{},
                                     "solution":0.0},
                                    {"CUTEst problem":"BOX3",
                                     "SIF params":{},
                                    ...
                                    {"CUTEst problem":"BOXPOWER",
                                     "SIF params":{"N":10},
                                     "solution":0.0},
                                    {"CUTEst problem":"BROYDNBDLS",
                                     "SIF params":{"N":50},
                                     "solution":0.0},
                                    {"CUTEst problem":"CHNROSNB",
                                     "SIF params":{"N":25},
                                     "solution":0.0},
                                    {"CUTEst problem":"COOLHANSLS",
                                     "SIF params":{},
                                     "solution":0.0},
                                    {"CUTEst problem":"HEART6LS",
                                     "SIF params":{},
                                     "solution":0.0}, 
                                    {"CUTEst problem":"METHANB8LS",
                                     "SIF params":{},
                                     "solution":0.0}, 
                                    {"CUTEst problem":"ROSENBR",
                                     "SIF params":{},
                                     "solution":0.0}, 
                                    {"CUTEst problem":"VIBRBEAM",
                                     "SIF params":{},
                                     "solution":0.15644607137}
                                   ]
        noise_type_list = ["additive scaled by starting point"]
        obj_noise_dict_list = [{"name":"symmetric uniform random sampler",
                                "scaling factor":0.0}
        ...
        raise ValueError("The low dimensional (0 < d <= 50) CUTEst benchmark %s is not implemented..." % benchmark_name)
...
EMNA_dict_list = [{"name":"EMNA",
                   ...
                   "sigma_0":1e-1,
                   "gamma":1e-3, 
                   "number of new samples to draw":"d+1",
                   "number of samples to keep":"half", 
                   "verbose":False}
                 ]
...
IMFIL_dict_list = [{"name":"IMFIL",
                    ...
                    "custom sampler":"None",
                    "number of custom sampler directions":0,
                    "stencil type":"asymmetric positive basis",
                    "tau_tr":0.5,
                    "tau_gr":1e-2,
...
NNAIF_dict_list = [{"name":"NNAIF",
                    ...
                    "stencil wins?":True,
                    "stencil gradient beta":1e-5,
                    "number of points desired to pass surrogate filter test":0,
...
# Benchmark setup 
# ===============
LOW_DIM_CUTEST_EXP_GROUPS = {}
benchmarks_list = ["Rosenbrock No Noise",
                   "Rosenbrock Scaled Noise",
                   "CUTEst No Noise",
                   "CUTEst Scaled Noise"
                  ]
...
for benchmark_name in benchmarks_list:
    benchmark_dict = get_low_dimensional_CUTEst_benchmark_dict(benchmark_name,
                                                               opt_dict_list)
    LOW_DIM_CUTEST_EXP_GROUPS["%s" % benchmark_name] = hu.cartesian_exp_group(benchmark_dict)
